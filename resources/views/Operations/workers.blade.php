...
{{-- Mobile-first Workers App — all styles scoped to .workers-app --}}
<style>
    .workers-app {
        ...
        margin: 0 auto;
        padding: 0 16px 24px;
        background: linear-gradient(180deg, var(--worker-surface) 0%, #fff 120px);
        min-height: 60vh;
        border-radius: var(--worker-radius);
    }
    ...
    .workers-badge--progress { background: #fef3c7; color: #92400e; }
    .workers-badge--done { background: #d1fae5; color: #065f46; }
            ...
            <table class="workers-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="{{ route('operations.work-orders.index') }}" class="workers-action-link">View</a></td>
                    </tr>
                    <tr>
                        <td>WO-1041</td>
                        <td>Oak Ave</td>
                        ...
                        <td>Crew B</td>
                        <td><span class="workers-badge workers-badge--progress">In Progress</span></td>
                        <td><a href="{{ route('operations.work-orders.index') }}" class="workers-action-link">View</a></td>
                    </tr>
                    <tr>
                        <td>WO-1040</td>
                        ...
                        <td>Crew A</td>
                        <td><span class="workers-badge workers-badge--done">Completed</span></td>
                        <td><a href="{{ route('operations.work-orders.index') }}" class="workers-action-link">View</a></td>
                    </tr>
                </tbody>
            </table>
