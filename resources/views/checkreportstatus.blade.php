        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('submitreport') }}">Report Issue</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('checkreportstatus') }}">Check Status</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="report-card">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="trackingNumber" class="form-label">Enter Your Report Number</label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="trackingNumber" placeholder="E.g., SMS-2023-0856">
                                <button class="btn btn-primary" type="button" id="trackButton">
                                    <i class="fas fa-search"></i> Track
                                </button>
                            </div>
                            <div class="form-text">You received this number when you submitted your report.</div>
                        </div>
                    </div>
                    ...
                    <div id="statusDisplay">
                        <div class="status-card resolved">
                            ...
                            <div class="mt-3">
                                <p class="mb-1"><strong>Updates:</strong></p>
                                <ul class="mb-0">
                                    <li>Oct 15, 9:30 AM - Report received and assigned to maintenance team</li>
                                    <li>Oct 15, 2:15 PM - Field crew dispatched to location</li>
                                    <li>Oct 15, 4:45 PM - Blockage cleared, area cleaned</li>
                                    <li>Oct 16, 10:00 AM - Issue marked as resolved</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="status-card in-progress">
                            ...
                            <div class="mt-3">
                                <p class="mb-1"><strong>Updates:</strong></p>
                                <ul class="mb-0">
                                    <li>Oct 18, 3:45 PM - Report received and assigned to inspection team</li>
                                    <li>Oct 19, 11:30 AM - Initial inspection completed, source identified</li>
                                    <li>Oct 20, 9:00 AM - Repair scheduled for October 23</li>
                                </ul>
                            </div>
                        </div>
                    </div>
