<x-layouts::customer :title="__('Customer Support') . ' – BruDMS'" :bare="true">
    ...
    <div style="position: fixed; top: 4vh; left: 20px; right: 20px; z-index: 10; display: flex; align-items: center; gap: 6px;">
        ...
        <span class="cust-title" style="font-size: 16px; font-weight: 600; font-family: Poppins, sans-serif;">{{ __('Customer Support') }}</span>
    </div>

    {{-- Content --}}
    <div style="position: fixed; top: 12vh; left: 20px; right: 20px; bottom: 20px; z-index: 5; padding: 2px;">
        <p class="cust-title" style="font-size: 17px; font-family: Poppins, sans-serif; font-weight: 600; margin: 0; margin-left: 24px;">Hi there, how can we help you?</p>
        <div style="margin-top: 24px; margin-left: 8px; margin-right: 8px; min-height: 260px; border-radius: 10px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.15); padding: 16px;">
            <p class="cust-subtitle" style="font-size: 13px; font-family: Poppins, sans-serif; font-weight: 600; margin: 0; margin-left: 4px; margin-top: 4px;">Announcements:</p>
        ...
        <div style="position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%); z-index: 10; max-width: 310px; width: calc(100% - 60px);">
            <a href="{{ route('customer.contactcustomersupport', ['name' => $user->profileSlug()]) }}" class="press-btn delayed-nav" style="display: flex; align-items: center; justify-content: center; gap: 8px; width: 100%; height: 42px; border-radius: 12px; background: var(--brudms-primary); color: #000; font-size: 13px; font-weight: 700; font-family: Poppins, sans-serif; text-decoration: none;">
