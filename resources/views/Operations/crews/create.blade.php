...
<div class="card" style="max-width:600px;">
    <form action="{{ route('operations.crews.store') }}" method="POST">
        ...
        <div style="margin-bottom:20px;">
            ...
            <input type="text" name="contact_phone" value="{{ old('contact_phone') }}" style="
                width:100%;
                padding:10px 12px;
                border:1px solid #d1d5db;
                border-radius:8px;
        ...
        <div style="margin-bottom:20px;">
            ...
            <input type="email" name="contact_email" value="{{ old('contact_email') }}" style="
                width:100%;
                padding:10px 12px;
                border:1px solid #d1d5db;
                border-radius:8px;
        ...
        <div style="margin-bottom:20px;">
            ...
            <input type="text" name="specialization" value="{{ old('specialization') }}" placeholder="e.g., Blockage Removal, Maintenance" style="
                width:100%;
                padding:10px 12px;
                border:1px solid #d1d5db;
                border-radius:8px;
