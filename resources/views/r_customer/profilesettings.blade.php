<x-layouts::customer :title="__('Profile Settings') . ' – BruDMS'" :bare="true">
    @push('styles')
        ...
        <style>
            ...
            #save-profile-btn.has-changes { background: var(--accent-blue) !important; border: none !important; color: black !important; cursor: pointer; }
    ...
    <div style="position: fixed; top: 4vh; left: 20px; right: 20px; z-index: 10; display: flex; align-items: center; gap: 6px;">
        ...
        <span class="cust-title" style="font-size: 16px; font-weight: 600; font-family: Poppins, sans-serif;">Profile settings</span>
    </div>
        ...
        <div style="display: flex; flex-direction: column; align-items: center; width: 100%; gap: 24px;">
            <div style="display: flex; align-items: flex-start; gap: 16px;">
                ...
                <label for="profile-photo-input" class="press-btn" id="circle-2-label" style="cursor: pointer; display: flex; flex-direction: column; align-items: center; margin-top: 20px;">
                    ...
                    <span style="margin-top: 6px; color: var(--accent-blue); font-family: Poppins, sans-serif; font-size: 11px; font-weight: 500;">Edit Picture</span>
                </label>
            </div>
            <form id="profile-form" method="POST" action="{{ route('customer.profile.update') }}" enctype="multipart/form-data" style="width: 100%; max-width: 400px; margin-top: 12px;">
                ...
                <input type="text" id="username-input" name="name" value="{{ old('name', $user->name ?? '') }}" placeholder="Muhammad Ali" style="width: 100%; height: 44px; padding: 0 16px; border-radius: 12px; class="cust-field" style="backdrop-filter: blur(1.5px); -webkit-backdrop-filter: blur(1.5px); font-family: Poppins, sans-serif; font-size: 14px; font-weight: 500; outline: none; box-sizing: border-box;">
                ...
                <div class="email-bind-wrap">
                    <input type="email" id="email-input" name="email" value="{{ $displayEmail }}" placeholder="you@example.com" style="width: 100%; height: 44px; padding: 0 16px; border-radius: 12px; class="cust-field" style="backdrop-filter: blur(1.5px); -webkit-backdrop-filter: blur(1.5px); font-family: Poppins, sans-serif; font-size: 14px; font-weight: 500; outline: none; box-sizing: border-box;">
    ...
    <div style="position: fixed; bottom: -18px; left: -10px; right: -10px; height: calc(10vh + 10px); background: rgba(255, 255, 255, 0.03); border: 2px solid rgba(255, 255, 255, 0.03); border-radius: 12px 12px 0 0; z-index: 15; display: flex; align-items: center; justify-content: center; gap: 16px; padding: 14px 36px 28px; box-sizing: border-box;">
        <a href="{{ route('customer.general', ['name' => $user->profileSlug()]) }}" class="press-btn delayed-nav bottom-bar-btn cust-btn-secondary" style="flex: 1; max-width: 220px; height: 42px; border-radius: 10px; background: rgba(66, 106, 120, 0.35); border: 2px solid rgba(255, 255, 255, 0.25); color: rgba(255, 255, 255, 0.65); font-family: Poppins, sans-serif; font-size: 14px; font-weight: 600; display: flex; align-items: center; justify-content: center; padding-top: 2px; text-decoration: none;">Cancel</a>
