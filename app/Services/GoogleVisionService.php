...
class GoogleVisionService
{
    ...
    {
        // Use config() so this works when config is cached (env() is null after config:cache)
        $envPath = config('services.google_vision.credentials') ?: env('GOOGLE_APPLICATION_CREDENTIALS');
        ...
        // Default path (fallback if env/config not set) - always absolute
