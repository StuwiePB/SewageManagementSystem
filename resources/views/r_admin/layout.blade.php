...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-item:hover { background: rgba(var(--brudms-primary-rgb), 0.1); color: var(--text-primary); }
        .nav-item.active { background: rgba(var(--brudms-primary-rgb), 0.2); color: var(--accent-blue); border-left-color: var(--accent-blue); }
        ...
        .back-link { display: inline-flex; align-items: center; padding: 0.5rem 1rem; border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 0.875rem; background: rgba(var(--brudms-primary-rgb), 0.2); color: var(--accent-blue); border: none; cursor: pointer; }
        ...
        .form-group input, .form-group select, .form-group textarea { width: 100%; padding: 0.5rem 0.75rem; background: var(--bg-primary); border: 1px solid rgba(var(--brudms-primary-rgb), 0.3); border-radius: 8px; color: var(--text-primary); font-size: 0.9375rem; }
        ...
        .search-filter-bar input { flex: 1; min-width: 200px; padding: 0.5rem 1rem; background: var(--bg-primary); border: 1px solid rgba(var(--brudms-primary-rgb), 0.3); border-radius: 8px; color: var(--text-primary); }
        .search-filter-bar select { padding: 0.5rem 1rem; background: var(--bg-primary); border: 1px solid rgba(var(--brudms-primary-rgb), 0.3); border-radius: 8px; color: var(--text-primary); }
        .table-wrap { overflow-x: auto; }
        table { width: 100%; border-collapse: collapse; }
        th, td { padding: 0.75rem 1rem; text-align: left; border-bottom: 1px solid rgba(var(--brudms-primary-rgb), 0.1); }
        ...
        .badge-operator { background: rgba(var(--brudms-primary-rgb), 0.2); color: var(--accent-blue); }
        ...
        .tab-nav { display: flex; gap: 0.5rem; margin-bottom: 1.5rem; border-bottom: 1px solid rgba(var(--brudms-primary-rgb), 0.15); }
        ...
        .nav-dropdown-menu a:hover { background: rgba(var(--brudms-primary-rgb), 0.1); color: var(--text-primary); }
        ...
        .form-control { width: 100%; padding: 0.5rem 0.75rem; background: var(--bg-primary); border: 1px solid rgba(var(--brudms-primary-rgb), 0.3); border-radius: 8px; color: var(--text-primary); font-size: 0.9375rem; }
        ...
        .pagination-bar { display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 1rem; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid rgba(var(--brudms-primary-rgb), 0.1); }
        .pagination-info { color: var(--text-secondary); font-size: 0.875rem; }
        .pagination-btns { display: flex; gap: 0.5rem; }
        .btn-page { display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.5rem 0.75rem; border-radius: 8px; font-size: 0.875rem; color: var(--accent-blue); text-decoration: none; background: rgba(var(--brudms-primary-rgb), 0.15); }
        .btn-page:hover:not(.disabled) { background: rgba(var(--brudms-primary-rgb), 0.25); }
        ...
        .btn-edit { padding: 0.4rem 0.9rem; background: rgba(var(--brudms-primary-rgb), 0.2); color: var(--accent-blue); border-radius: 8px; text-decoration: none; font-size: 0.875rem; font-weight: 500; }
        .btn-edit:hover { background: rgba(var(--brudms-primary-rgb), 0.3); }
