...
<div class="topbar">
    ...
    <div style="display:flex; gap:12px;">
        ...
        <a href="{{ route('operations.statistics.export.csv', $params) }}" class="btn btn-primary">Export CSV (Excel)</a>
        <a href="{{ route('operations.statistics.export.pdf', $params) }}" target="_blank" rel="noopener" class="btn btn-secondary">Print / Save as PDF</a>
        <a href="{{ route('operations.statistics.index') }}" class="btn btn-secondary">Back</a>
    </div>
</div>
...
<div class="card" style="margin-bottom:20px; padding:0; overflow:hidden;">
    ...
    <div style="position:relative;">
        ...
        <div style="display:flex; align-items:center; gap:8px; margin-bottom:4px;"><span style="display:inline-block; width:16px; height:16px; border-radius:2px; background:#f97316;"></span> High (61% – 80%)</div>
        <div style="display:flex; align-items:center; gap:8px;"><span style="display:inline-block; width:16px; height:16px; border-radius:2px; background:#dc2626;"></span> Very High (81% – 100%)</div>
        </div>
    </div>
</div>
